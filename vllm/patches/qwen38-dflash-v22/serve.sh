#!/bin/bash
# Reference serving command for qwen3.8-27b(-fp8) on llm-scaler-vllm-adv:v22
# (2x Intel Arc Pro B70, TP=2). Evolves patches/qwen38-dflash-v21/serve.sh:
...
IMAGE="${IMAGE:-llm-scaler-vllm-adv:v22}"
NAME="${NAME:-lsv-test}"
PORT="${PORT:-8000}"
SPEC_K="${SPEC_K:-4}"
