...
class Scheduler(SchedulerInterface):
    ...
    def _mamba_block_aligned_split(
        ...
        if num_computed_tokens < max(request.num_prompt_tokens, request.num_tokens - 1):
            ...
            #   - v52k: lo = est - num_output_placeholders (self-correcting
            ...
            if (
                ...
                if w_max >= num_new_tokens:
                    ...
                    logger.warning(
                        "llm-scaler v52k BOUNDARY-CLAMP: %s est=%d lo=%d "
                    ...
                    if lo == est:
                        ...
                        logger.warning(
                            "llm-scaler v52k BOUNDARY-SPAN-CORNER: %s "
                        ...
                        # guard below.
                        logger.warning(
                            "llm-scaler v52k BOUNDARY-SKIP: %s est=%d "
                    ...
                    logger.warning(
                        "llm-scaler v52k BOUNDARY-SKIP: %s est=%d lo=%d "
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            if self.need_mamba_block_aligned_split:
                ...
                # llm-scaler v52k: returning 0 for the sole runnable
                # request would produce a 0-token SchedulerOutput, which
                # asserts on the workers
                # (_prepare_inputs assert total_num_scheduled_tokens > 0).
                if (
                    num_new_tokens == 0
                    ...
                    logger.warning(
                        "llm-scaler v52k BOUNDARY-SPAN-FORCED: %s est=%d "
                        "sole runnable request; 2-row bounded span instead "
                        "of empty step",
                        request.request_id,
                        request.num_computed_tokens,
                    )
