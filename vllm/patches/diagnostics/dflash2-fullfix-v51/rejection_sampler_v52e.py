...
class RejectionSampler(nn.Module):
    ...
    def forward(
        ...
        # llm-scaler v52e (crash-4 R1 attribution): keep refs so the model
        # runner can dump the bonus/target data when get_output() observes
        # an empty rejection-sampler row (refs only; no copies, no syncs).
        self._v52e_bonus = bonus_token_ids
        self._v52e_targ = target_logits
