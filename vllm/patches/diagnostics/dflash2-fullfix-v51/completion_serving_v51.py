...
class OpenAIServingCompletion(OpenAIServing):
    ...
    async def completion_stream_generator(
        ...
        try:
            ...
            # llm-scaler v51 (F9 serving companion): see chat_completion
            # stream generator — deterministically close the engine
            # generator so the crash-3 zombie leak cannot form when this
            # SSE generator ends via a handled exception.
