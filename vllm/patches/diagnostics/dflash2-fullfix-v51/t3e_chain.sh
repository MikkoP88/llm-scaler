#!/bin/bash
# t3e_chain.sh — boot df7t3e lane (v1.2.5t3e), health-wait, warmup, battery.
LOG=/root/build/df7t3e_boot.out
{
...
nohup python3 /root/build/dt_loop8t07.py > /root/build/loop8t07_df7t3e.out 2>&1 &
