#!/bin/bash
# Reference serving command for qwen3.8-27b(-fp8) on llm-scaler-vllm-adv:v23
...
#     peer barrier before the spec drafter; fixes the #11 large-prompt
#     request loss with MTP. VLLM_SPEC_PREFILL_BARRIER=0 restores v22.
#
# Usage:
...
IMAGE="${IMAGE:-llm-scaler-vllm-adv:v23}"
NAME="${NAME:-lsv-test}"
PORT="${PORT:-8000}"
SPEC_K="${SPEC_K:-4}"
