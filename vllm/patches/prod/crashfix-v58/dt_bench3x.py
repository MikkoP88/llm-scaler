#!/usr/bin/env python3
"""dt_bench3x — bench3 + ctx128k cell (§24 Q: copy-on-hit screen).

Identical to dt_bench3 (streaming TTFT + decode tok/s at 2k/16k/65k
contexts, 8-way concurrent short-request aggregate throughput, spec
acceptance delta from /metrics) plus a ctx128k cell to answer the
"does the PC warm dip grow at 128k" question directly.
"""
import json
import re
import threading
...
def main():
    ...
    stream_once("ctx128k", long_prompt(128000), 256)
    conc(8, "conc8")
    m1 = metrics()
