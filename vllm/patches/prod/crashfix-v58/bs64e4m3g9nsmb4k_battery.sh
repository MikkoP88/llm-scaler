...
bash repro_bootBS64_E4M3_G9NS_MB4K.sh BS64E4M3G9NSMB4KB > lce1/boot_BS64E4M3G9NSMB4KB.out 2>&1 || true
if ! grep -q HEALTH_OK lce1/boot_BS64E4M3G9NSMB4KB.out; then
  echo "BOOT_FAIL"; tail -20 lce1/boot_BS64E4M3G9NSMB4KB.out; exit 1
fi
grep -m1 HEALTH_OK lce1/boot_BS64E4M3G9NSMB4KB.out
...
nohup bash repro_sustain.sh 30 > lce1/sustain_BS64E4M3G9NSMB4KB.out 2>&1 &
