...
# --block-size 64 + async OFF + gmu 0.9 + --max-num-batched-tokens 4096
...
sleep 10
echo "[BATT] boot e4m3 bs64 gmu0.9 no-async mnbt4096 $(date +%H:%M:%S)"
bash repro_bootBS64_E4M3_G9NS_MB4K_NPC.sh BS64E4M3G9NSMB4KNPCB > lce1/boot_BS64E4M3G9NSMB4KNPCB.out 2>&1 || true
if ! grep -q HEALTH_OK lce1/boot_BS64E4M3G9NSMB4KNPCB.out; then
  echo "BOOT_FAIL"; tail -20 lce1/boot_BS64E4M3G9NSMB4KNPCB.out; exit 1
fi
grep -m1 HEALTH_OK lce1/boot_BS64E4M3G9NSMB4KNPCB.out
...
nohup bash repro_sustain.sh 30 > lce1/sustain_BS64E4M3G9NSMB4KNPCB.out 2>&1 &
