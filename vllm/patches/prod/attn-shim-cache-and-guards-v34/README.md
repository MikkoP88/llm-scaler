# attn-shim-cache-and-guards v34 — the latency question answered end-to-end: fabric at
...
4. **#18 CLOSED intrinsic** (fp8-nospec greedy bimodality):
   ...
   attn-esimd-fp8-reroute-v38/README.md.]
...
REMOVED (boot patch `vllm/patches/prod/spec-k4-unclamp-v35/v35_k4_unclamp.py`,
