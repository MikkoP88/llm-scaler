...
(patches/qwen38-dflash-v26/build_vxk_wheel.sh) and the proven v27-ccl1717
library-overlay pattern (patches/qwen38-dflash-v27-ccl1717/Dockerfile).
...
Follow qwen38-dflash-v27-ccl1717 exactly: copy the built
